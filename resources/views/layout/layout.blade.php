    ...
    @section("header")
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg"><b>OM Shai</b> Sweets</span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="{{url('products')}}"><i class="fa fa-circle"></i> <span>Products</span></a></li>
                    <li><a href="{{url('items')}}"><i class="fa fa-circle"></i> <span>Items</span></a></li>
                    <li class="treeview">
                        <a href="#">
