                    ...
                    <div class="box-body">
                        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <a type="button" href="{{url('item/add')}}" class="btn btn-block btn-primary">Add Item</a>
                                </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable"
                                        ...
                                        @if(count($itemdetails)>0)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('item/edit',['id'=>$itemdetail->itemid])}}"><i class="fa fa-edit"></i></a>
                                                    <a style="cursor: pointer" class="delete" id="{{$itemdetail->itemid}}"><i class="fa fa-trash "></i></a>
                                                    <a href="{{url('item/detail',['id'=>$itemdetail->itemid])}}"><i class="fa fa-th-large"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        @else
